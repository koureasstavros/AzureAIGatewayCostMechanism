...
- contributors #this requires that you already have set this group into the users who need access of the consolidated data
...
There is the need that the api for information contains all available products as the normal api for api consumption
...
There is the need to add this contributors apim group into IAM with the following permissions:
